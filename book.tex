...
(``Memset\_explicit'' \protect\hyperlink{ref-MemSetProposal}{2021}).
...
GNU presents in (``10.604 Memset\_explicit,''
\protect\hyperlink{ref-GNUMemSet}{n.d.}). The information may be present
somewhere in the machine, even if it was erased from memory.
