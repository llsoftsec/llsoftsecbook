...
simply place
\phantomsection\label{__index_entry_14}{shellcode}\index{shellcode} of
...
\textbf{\phantomsection\label{__index_entry_15}{gadgets}\index{gadgets}}.
...
In \phantomsection\label{__index_entry_16}{return-oriented programming
...
call stack (often called a \phantomsection\label{__index_entry_17}{ROP
...
\phantomsection\label{__index_entry_18}{stack
...
use ``\phantomsection\label{__index_entry_19}{gadget
...
\phantomsection\label{__index_entry_20}{Jump-oriented programming
...
through a \phantomsection\label{__index_entry_21}{dispatcher
...
\phantomsection\label{__index_entry_22}{Counterfeit Object-oriented
programming
...
\phantomsection\label{__index_entry_23}{C++}\index{C++} virtual function
...
\phantomsection\label{__index_entry_24}{vfgadgets}\index{vfgadgets}. To
...
\phantomsection\label{__index_entry_25}{sigreturn-oriented programming
...
\phantomsection\label{__index_entry_26}{registers}\index{register}.
Overwriting value in machine registers directly is often not possible.
Attackers use \phantomsection\label{__index_entry_27}{memory
...
\href{https://en.wikipedia.org/wiki/Address_space_layout_randomization}{\phantomsection\label{__index_entry_28}{Address
...
often referred to as an ``\phantomsection\label{__index_entry_29}{info
...
\href{https://en.wikipedia.org/wiki/Control-flow_integrity}{\phantomsection\label{__index_entry_30}{Control-flow
...
to as \phantomsection\label{__index_entry_31}{forward-edge
CFI}\index{forward-edge CFI}, whereas a scheme that protects returns is
said to implement \phantomsection\label{__index_entry_32}{backward-edge
...
\phantomsection\label{__index_entry_33}{coarse-grained}\index{coarse-grained CFI}
or
\phantomsection\label{__index_entry_34}{fine-grained}\index{fine-grained CFI}.
...
\phantomsection\label{__index_entry_35}{equivalence
...
\phantomsection\label{__index_entry_36}{signature}\index{function signature}.

For example,
\phantomsection\label{__index_entry_37}{arm64e}\index{arm64e} and
\phantomsection\label{__index_entry_38}{pauthabi}\index{pauthabi} put
...
\phantomsection\label{__index_entry_39}{C++}\index{C++} virtual function
...
\href{https://en.wikipedia.org/wiki/Branch_table}{\phantomsection\label{__index_entry_40}{jump
...
\phantomsection\label{__index_entry_41}{arm64e}\index{arm64e} and
\phantomsection\label{__index_entry_42}{pauthabi}\index{pauthabi} do, as
...
``\phantomsection\label{__index_entry_43}{return
...
\item
  ...
  \href{https://www.usenix.org/conference/usenixsecurity25/presentation/bajo}{\phantomsection\label{__index_entry_44}{Coroutine
  Frame-Oriented Programming
  (CFOP)}\index{Coroutine Frame-Oriented Programming (CFOP)}}.
\item
  \phantomsection\label{__index_entry_45}{Procedure Linkage Table
  (PLT)}\index{Procedure Linkage Table (PLT)} and the
  \href{https://en.wikipedia.org/wiki/Global_Offset_Table}{\phantomsection\label{__index_entry_46}{Global
...
\item
  ...
  \hyperref[sec:sigreturn-oriented-programming]{2.4.4} for more details.
...
\href{https://clang.llvm.org/docs/ShadowCallStack.html}{\phantomsection\label{__index_entry_47}{Shadow
...
One such example is \phantomsection\label{__index_entry_48}{Pointer
...
address, called a \phantomsection\label{__index_entry_49}{Pointer
...
\emph{\phantomsection\label{__index_entry_50}{signed
pointer}\index{signed pointer}}. A non-signed pointer is called a
\emph{\phantomsection\label{__index_entry_51}{raw
...
\phantomsection\label{__index_entry_52}{key}\index{key} and a
\phantomsection\label{__index_entry_53}{modifier}\index{modifier}:
...
\item
  ...
  called a \phantomsection\label{__index_entry_54}{pointer substitution
...
\phantomsection\label{__index_entry_55}{pointer substitution
...
\href{https://developer.arm.com/documentation/102433/0100/Jump-oriented-programming?lang=en}{\phantomsection\label{__index_entry_56}{Branch
...
overwriting \phantomsection\label{__index_entry_57}{control
...
\phantomsection\label{__index_entry_58}{Non-control data
attacks}\index{Non-control data attacks} entry=``non-control data
attacks''\}, also known as
\phantomsection\label{__index_entry_59}{data-only
...
to
\phantomsection\label{__index_entry_60}{C}\index{C}/\phantomsection\label{__index_entry_61}{C++}\index{C++}
programmers to help them detect vulnerabilities that can lead to memory
errors.

\subsection{Sanitizers}\label{sanitizers}

\phantomsection\label{__index_entry_62}{Sanitizers}\index{sanitizers}
...
\phantomsection\label{__index_entry_63}{fuzzers}\index{fuzzing}\footnote{\href{https://en.wikipedia.org/wiki/Fuzzing}{\phantomsection\label{__index_entry_64}{Fuzzing}\index{fuzzing}}
...
\href{https://clang.llvm.org/docs/AddressSanitizer.html}{\phantomsection\label{__index_entry_65}{Address
...
use-after-free, double-free and invalid free\footnote{ASan also includes
  a
  \href{https://clang.llvm.org/docs/LeakSanitizer.html}{\phantomsection\label{__index_entry_66}{memory
  leak detector}\index{LeakSanitizer}}.}. There are Address Sanitizer
implementations for both
\phantomsection\label{__index_entry_67}{GCC}\index{GCC} and
\phantomsection\label{__index_entry_68}{Clang}\index{Clang}, but we will
focus on the Clang implementation here.

ASan uses \phantomsection\label{__index_entry_69}{shadow
...
\phantomsection\label{__index_entry_70}{\texttt{malloc}}\index{malloc}
and \phantomsection\label{__index_entry_71}{\texttt{free}}\index{free}
with its own specialized versions. \texttt{malloc} introduces
\phantomsection\label{__index_entry_72}{redzones}\index{redzone} before
...
the Linux kernel,
\href{https://www.kernel.org/doc/html/v5.0/dev-tools/kasan.html}{\phantomsection\label{__index_entry_73}{KASAN}\index{KASAN}}.

ASan's biggest drawback is its high runtime overhead and memory usage,
due to the quarantine, redzones and shadow memory.
\href{https://clang.llvm.org/docs/HardwareAssistedAddressSanitizerDesign.html}{\phantomsection\label{__index_entry_74}{Hardware-assisted
AddressSanitizer
...
On \phantomsection\label{__index_entry_75}{AArch64}\index{AArch64},
HWASAN uses \phantomsection\label{__index_entry_76}{Top-Byte Ignore
...
\href{https://llvm.org/docs/MemTagSanitizer.html}{\phantomsection\label{__index_entry_77}{MemTagSanitizer}\index{MemTagSanitizer}}
goes one step further and uses the Armv8.5-A
\href{https://developer.arm.com/documentation/102925/0100}{\phantomsection\label{__index_entry_78}{Memory
...
\href{https://clang.llvm.org/docs/UndefinedBehaviorSanitizer.html\#ubsan-checks}{\phantomsection\label{__index_entry_79}{UndefinedBehaviorSanitizer
...
\tightlist
\item
  \href{https://clang.llvm.org/docs/MemorySanitizer.html}{\phantomsection\label{__index_entry_80}{MemorySanitizer}\index{MemorySanitizer}}:
  detects uninitialized reads.
\item
  \href{https://clang.llvm.org/docs/ThreadSanitizer.html}{\phantomsection\label{__index_entry_81}{ThreadSanitizer}\index{ThreadSanitizer}}:
  detects data races.
\item
  \href{https://llvm.org/docs/GwpAsan.html}{\phantomsection\label{__index_entry_82}{GWP-ASan}\index{GWP-ASan}}:
...
``\phantomsection\label{__index_entry_83}{spatial memory
safety}\index{spatial memory safety}''. Out-of-bounds accesses result in
restricted \phantomsection\label{__index_entry_84}{read/write
primitives}\index{read primitive}\phantomsection\label{__index_entry_85}{}\index{write primitive}\footnote{These
...
catch \phantomsection\label{__index_entry_86}{intra-object
...
annotations at
\href{https://en.wikipedia.org/wiki/Application_binary_interface}{\phantomsection\label{__index_entry_87}{Application
...
introduces
\emph{\phantomsection\label{__index_entry_88}{capabilities}\index{capability}}
...
\phantomsection\label{__index_entry_89}{\href{https://en.wikipedia.org/wiki/Just-in-time_compilation}{just-in-time
...
\phantomsection\label{__index_entry_90}{deoptimization}\index{deoptimization}
or \phantomsection\label{__index_entry_91}{on-stack replacement
...
\phantomsection\label{__index_entry_92}{range
analysis}\index{range analysis} to determine as precise a range for a
value as possible, which is useful for
\phantomsection\label{__index_entry_93}{bounds check
elimination}\index{bounds check elimination}.

\phantomsection\label{__index_entry_94}{Bounds check elimination
...
\item
  ...
  built on top of
  \href{https://v8.dev/blog/pointer-compression}{\phantomsection\label{__index_entry_95}{pointer
...
\item
  ...
  \href{https://en.wikipedia.org/wiki/W\%5EX}{\phantomsection\label{__index_entry_96}{W\^{}X}\index{W\textasciicircum{}X}}.
...
A \textbf{\phantomsection\label{__index_entry_97}{covert
channel}\index{covert channel}} is a channel where both entities intend
to communicate. A
\textbf{\phantomsection\label{__index_entry_98}{side-channel}\index{side-channel}}
...
\textbf{\phantomsection\label{__index_entry_99}{victim}\index{victim}}.
The other entity is sometimes called the
\textbf{\phantomsection\label{__index_entry_100}{spy}\index{spy}}.
...
\phantomsection\label{__index_entry_101}{micro-architectural}\index{micro-architectural}
...
\phantomsection\label{__index_entry_102}{timing
...
\href{https://en.wikipedia.org/wiki/Cache_(computing)}{\phantomsection\label{__index_entry_103}{Caches}\index{cache}}
...
\phantomsection\label{__index_entry_104}{access
...
\textbf{\phantomsection\label{__index_entry_105}{cache
hit}\index{cache!hit}}. Otherwise, it's called a
\textbf{\phantomsection\label{__index_entry_106}{cache
miss}\index{cache!miss}}.

Most systems have \phantomsection\label{__index_entry_107}{multiple
levels of cache}\index{cache!multi-level}, each with a different
trade-off between \phantomsection\label{__index_entry_108}{cache
size}\index{cache!size} and
\phantomsection\label{__index_entry_109}{access
...
\href{https://en.wikipedia.org/wiki/Locality_of_reference}{\phantomsection\label{__index_entry_110}{principle
of
locality}\index{principle of locality}}{]}\phantomsection\label{__index_entry_111}{}\index{locality of reference}.

Data is stored and transferred between cache levels in blocks of aligned
memory. Such a block is called a
\textbf{\phantomsection\label{__index_entry_112}{cache
block}\index{cache!block}} or
\textbf{\phantomsection\label{__index_entry_113}{cache
...
\textbf{\phantomsection\label{__index_entry_114}{evicting}\index{cache!eviction}},
some other address/data from it. How that choice gets made is decided by
the
\href{https://en.wikipedia.org/wiki/Cache_replacement_policies}{\phantomsection\label{__index_entry_115}{cache
replacement policy}\index{cache!replacement policy}}{]}. Popular
replacement algorithms are
\phantomsection\label{__index_entry_116}{Least Recently Used
(LRU)}\index{cache!LRU},
\phantomsection\label{__index_entry_117}{Random}\index{cache!random replacement policy}
and
\phantomsection\label{__index_entry_118}{pseudo-LRU}\index{cache!pseudo-LRU replacement policy}.
...
the cache is
\textbf{\phantomsection\label{__index_entry_119}{fully-associative}\index{cache!fully-associative}}.
Most caches are however not fully-associative, as it's too costly to
implement. Instead, most caches are
\textbf{\phantomsection\label{__index_entry_120}{set-associative}\index{cache!set-associative}}.
...
\textbf{\phantomsection\label{__index_entry_121}{direct-mapped}\index{cache!direct-mapped}},
...
is called a \textbf{\phantomsection\label{__index_entry_122}{cache
set}\index{cache!set}}.
...
\phantomsection\label{__index_entry_123}{Cache
...
In a so-called
\textbf{\phantomsection\label{__index_entry_124}{Flush+Reload}\index{Flush+Reload}}
...
In a
\textbf{\phantomsection\label{__index_entry_125}{Prime+Probe}\index{Prime+Probe}}
...
\item
  ...
  (\textbf{\phantomsection\label{__index_entry_126}{reset
  sequence}\index{reset sequence}}).
\item
  An instruction sequence that triggers a state change
  (\textbf{\phantomsection\label{__index_entry_127}{trigger
  sequence}\index{trigger sequence}}).
\item
  An instruction sequence that leaks the inner state
  (\textbf{\phantomsection\label{__index_entry_128}{measurement
  sequence}\index{measurement sequence}}).
\end{enumerate}

Other cache-based side channel attacks following this general 3-step
approach include:
\phantomsection\label{__index_entry_129}{Flush+Flush}\index{Flush+Flush}(\citeproc{ref-Gruss2016a}{Gruss,
Maurice, Wagner, et al. 2016}),
\phantomsection\label{__index_entry_130}{Flush+Prefetch}\index{Flush+Prefetch}(\citeproc{ref-Gruss2016}{Gruss,
Maurice, Fogh, et al. 2016}),
\phantomsection\label{__index_entry_131}{Evict+Reload}\index{Evict+Reload}(\citeproc{ref-Percival2005}{Percival
2005}),
\phantomsection\label{__index_entry_132}{Evict+Time}\index{Evict+Time}(\citeproc{ref-Osvik2005}{Osvik,
Shamir, and Tromer 2005}),
\phantomsection\label{__index_entry_133}{Reload+Refresh}\index{Reload+Refresh}(\citeproc{ref-Briongos2020}{Briongos
et al. 2020}),
\phantomsection\label{__index_entry_134}{Collide+Probe}\index{Collide+Probe}(\citeproc{ref-Lipp2020}{Lipp
et al. 2020}), etc.
...
\href{https://en.wikipedia.org/wiki/Multithreading_(computer_architecture)}{\phantomsection\label{__index_entry_135}{cpu
...
\href{https://developer.chrome.com/blog/site-isolation/}{\phantomsection\label{__index_entry_136}{site
...
method}\phantomsection\label{__index_entry_137}{}\index{Spectre}.
...
\phantomsection\label{__index_entry_138}{NetSpectre}\index{NetSpectre}
...
\href{https://en.wikipedia.org/wiki/Instruction_pipelining}{\phantomsection\label{__index_entry_139}{instruction
pipelines}\index{instruction pipeline}}.
\phantomsection\label{__index_entry_140}{}\index{pipeline} In an
...
\phantomsection\label{__index_entry_141}{predict}\index{predict} which
...
\href{https://en.wikipedia.org/wiki/Branch_predictor}{\phantomsection\label{__index_entry_142}{branch
...
\item
  ...
  \phantomsection\label{__index_entry_143}{conditional
  branch}\index{conditional branch direction predictor}:
  \phantomsection\label{__index_entry_144}{taken}\index{taken branch} or
  not taken. The prediction is typically
  \phantomsection\label{__index_entry_145}{history-based}\index{history-based prediction},
  i.e.~based on the outcome of this and other branches in the recent
  past.
\item
  A predictor of the \phantomsection\label{__index_entry_146}{target of
...
\item
  ...
  \phantomsection\label{__index_entry_147}{predict the next instruction
...
\phantomsection\label{__index_entry_148}{}\index{conditional branch direction predictor}

Two examples are
\phantomsection\label{__index_entry_149}{BranchScope}\index{BranchScope}
(\citeproc{ref-Evtyushkin2018}{Evtyushkin et al. 2018}) and
\phantomsection\label{__index_entry_150}{BlueThunder}\index{BlueThunder}
...
\hyperref[aslr]{\phantomsection\label{__index_entry_151}{ASLR}\index{ASLR}}.

\subsubsection{Branch target predictor side-channel
attacks}\label{branch-target-predictor-side-channel-attacks}

\phantomsection\label{__index_entry_152}{}\index{Branch target predictor}

Two examples are
\phantomsection\label{__index_entry_153}{SBPA}\index{SBPA}
(\citeproc{ref-Aciicmez2007}{Aciiçmez, Kaya Koç, and Seifert 2007}) and
\phantomsection\label{__index_entry_154}{BranchShadow}\index{BranchShadow}
(\citeproc{ref-Lee2017}{Lee et al. 2017}). These earlier attacks are
based on making a branch in the spy process alias in the
\phantomsection\label{__index_entry_155}{Branch Target Buffer
...
\phantomsection\label{__index_entry_156}{last branch
records}\index{last branch record},
\phantomsection\label{__index_entry_157}{instruction
traces}\index{instruction trace} or
\phantomsection\label{__index_entry_158}{performance
...
\phantomsection\label{__index_entry_159}{}\index{return address predictor}

One example is
\phantomsection\label{__index_entry_160}{Hyper-Channel}\index{Hyper-Channel}
...
\item
  ...
  (\emph{\phantomsection\label{__index_entry_161}{reset
...
\textbf{\phantomsection\label{__index_entry_164}{control
...
\textbf{\phantomsection\label{__index_entry_165}{true data
dependencies}\index{true data dependency}},
\textbf{\phantomsection\label{__index_entry_166}{anti-dependencies}\index{data dependency}}
and \textbf{\phantomsection\label{__index_entry_167}{output
...
\textbf{\phantomsection\label{__index_entry_168}{predictions}\index{prediction}}.
...
\textbf{\phantomsection\label{__index_entry_169}{speculation}\index{speculation}}.
...
\textbf{\phantomsection\label{__index_entry_170}{mis-speculation}\index{mis-speculation}},
are called \textbf{\phantomsection\label{__index_entry_171}{transient
instructions}\index{transient instructions}}.\footnote{Transient
  ...
  been called
  \textbf{\phantomsection\label{__index_entry_172}{wrong-path
...
\textbf{\phantomsection\label{__index_entry_173}{architectural
effects}\index{architectural effects}} of transient instructions need to
be undone, but the
\textbf{\phantomsection\label{__index_entry_174}{micro-architectural
...
\textbf{\phantomsection\label{__index_entry_175}{Faulting
...
\textbf{\phantomsection\label{__index_entry_176}{transient
...
\textbf{\phantomsection\label{__index_entry_177}{Transient execution
...
\phantomsection\label{__index_entry_178}{Spectre}\index{Spectre}
(\citeproc{ref-Kocher2019}{Kocher et al. 2019}) and
\phantomsection\label{__index_entry_179}{Meltdown}\index{Meltdown}
...
\phantomsection\label{__index_entry_180}{dead store optimization
...
It still uses
\phantomsection\label{__index_entry_181}{\texttt{memset}}\index{memset}
