...
In a so-called \textbf{Flush+Reload}\index{Flush+Reload} attack(Yarom
and Falkner \protect\hyperlink{ref-Yarom2014}{2014}), the spy process
shares memory with the victim process. The attack works in 3 steps:
...
follow a similar 3-step pattern. (Weber et al.
...
attack (Schwarz et al. \protect\hyperlink{ref-Schwarz2019}{2019}) where
...
\protect\hyperlink{ref-Evtyushkin2018}{2018})\index{BranchScope} and
BlueThunder (Huo et al.
\protect\hyperlink{ref-Huo2019}{2019})\index{BlueThunder}. These attacks
...
\protect\hyperlink{ref-Aciicmez2007}{2007})\index{SBPA} and BranchShadow
(Lee et al. \protect\hyperlink{ref-Lee2017}{2017})\index{BranchShadow}.
These earlier attacks are based on making a branch in the spy process
alias in the BTB\index{BTB} with a targeted branch in the victim
...
\protect\hyperlink{ref-Bulygin2008}{2008})\index{Hyper-Channel}. In this
