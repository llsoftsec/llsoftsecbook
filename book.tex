...
\item
  ...
  \href{https://www.usenix.org/conference/usenixsecurity25/presentation/bajo}{\phantomsection\label{__index_entry_46}{Coroutine
  Frame-Oriented Programming
  (CFOP)}\index{Coroutine Frame-Oriented Programming (CFOP)}}.
\item
  \phantomsection\label{__index_entry_47}{Procedure Linkage Table
  (PLT)}\index{Procedure Linkage Table (PLT)} and the
  \href{https://en.wikipedia.org/wiki/Global_Offset_Table}{\phantomsection\label{__index_entry_48}{Global
...
\href{https://clang.llvm.org/docs/ShadowCallStack.html}{\phantomsection\label{__index_entry_49}{Shadow
...
One such example is \phantomsection\label{__index_entry_50}{Pointer
...
address, called a \phantomsection\label{__index_entry_51}{Pointer
...
\emph{\phantomsection\label{__index_entry_52}{signed
pointer}\index{signed pointer}}. A non-signed pointer is called a
\emph{\phantomsection\label{__index_entry_53}{raw
...
\phantomsection\label{__index_entry_54}{key}\index{key} and a
\phantomsection\label{__index_entry_55}{modifier}\index{modifier}:
...
\item
  ...
  called a \phantomsection\label{__index_entry_56}{pointer substitution
...
\phantomsection\label{__index_entry_57}{pointer substitution
...
\href{https://developer.arm.com/documentation/102433/0100/Jump-oriented-programming?lang=en}{\phantomsection\label{__index_entry_58}{Branch
...
overwriting \phantomsection\label{__index_entry_59}{control
...
\phantomsection\label{__index_entry_60}{Non-control data
attacks}\index{Non-control data attacks} entry=``non-control data
attacks''\}, also known as
\phantomsection\label{__index_entry_61}{data-only
...
to
\phantomsection\label{__index_entry_62}{C}\index{C}/\phantomsection\label{__index_entry_63}{C++}\index{C++}
programmers to help them detect vulnerabilities that can lead to memory
errors.

\subsection{Sanitizers}\label{sanitizers}

\phantomsection\label{__index_entry_64}{Sanitizers}\index{sanitizers}
...
\phantomsection\label{__index_entry_65}{fuzzers}\index{fuzzing}\footnote{\href{https://en.wikipedia.org/wiki/Fuzzing}{\phantomsection\label{__index_entry_66}{Fuzzing}\index{fuzzing}}
...
\href{https://clang.llvm.org/docs/AddressSanitizer.html}{\phantomsection\label{__index_entry_67}{Address
...
use-after-free, double-free and invalid free\footnote{ASan also includes
  a
  \href{https://clang.llvm.org/docs/LeakSanitizer.html}{\phantomsection\label{__index_entry_68}{memory
  leak detector}\index{LeakSanitizer}}.}. There are Address Sanitizer
implementations for both
\phantomsection\label{__index_entry_69}{GCC}\index{GCC} and
\phantomsection\label{__index_entry_70}{Clang}\index{Clang}, but we will
focus on the Clang implementation here.

ASan uses \phantomsection\label{__index_entry_71}{shadow
...
\phantomsection\label{__index_entry_72}{\texttt{malloc}}\index{malloc}
and \phantomsection\label{__index_entry_73}{\texttt{free}}\index{free}
with its own specialized versions. \texttt{malloc} introduces
\phantomsection\label{__index_entry_74}{redzones}\index{redzone} before
...
the Linux kernel,
\href{https://www.kernel.org/doc/html/v5.0/dev-tools/kasan.html}{\phantomsection\label{__index_entry_75}{KASAN}\index{KASAN}}.

ASan's biggest drawback is its high runtime overhead and memory usage,
due to the quarantine, redzones and shadow memory.
\href{https://clang.llvm.org/docs/HardwareAssistedAddressSanitizerDesign.html}{\phantomsection\label{__index_entry_76}{Hardware-assisted
AddressSanitizer
...
On \phantomsection\label{__index_entry_77}{AArch64}\index{AArch64},
HWASAN uses \phantomsection\label{__index_entry_78}{Top-Byte Ignore
...
\href{https://llvm.org/docs/MemTagSanitizer.html}{\phantomsection\label{__index_entry_79}{MemTagSanitizer}\index{MemTagSanitizer}}
goes one step further and uses the Armv8.5-A
\href{https://developer.arm.com/documentation/102925/0100}{\phantomsection\label{__index_entry_80}{Memory
...
\href{https://clang.llvm.org/docs/UndefinedBehaviorSanitizer.html\#ubsan-checks}{\phantomsection\label{__index_entry_81}{UndefinedBehaviorSanitizer
...
\tightlist
\item
  \href{https://clang.llvm.org/docs/MemorySanitizer.html}{\phantomsection\label{__index_entry_82}{MemorySanitizer}\index{MemorySanitizer}}:
  detects uninitialized reads.
\item
  \href{https://clang.llvm.org/docs/ThreadSanitizer.html}{\phantomsection\label{__index_entry_83}{ThreadSanitizer}\index{ThreadSanitizer}}:
  detects data races.
\item
  \href{https://llvm.org/docs/GwpAsan.html}{\phantomsection\label{__index_entry_84}{GWP-ASan}\index{GWP-ASan}}:
...
``\phantomsection\label{__index_entry_85}{spatial memory
safety}\index{spatial memory safety}''. Out-of-bounds accesses result in
restricted \phantomsection\label{__index_entry_86}{read/write
primitives}\index{read primitive}\phantomsection\label{__index_entry_87}{}\index{write primitive}\footnote{These
...
catch \phantomsection\label{__index_entry_88}{intra-object
...
annotations at
\href{https://en.wikipedia.org/wiki/Application_binary_interface}{\phantomsection\label{__index_entry_89}{Application
...
introduces
\emph{\phantomsection\label{__index_entry_90}{capabilities}\index{capability}}
...
\phantomsection\label{__index_entry_91}{\href{https://en.wikipedia.org/wiki/Just-in-time_compilation}{just-in-time
...
\phantomsection\label{__index_entry_92}{deoptimization}\index{deoptimization}
or \phantomsection\label{__index_entry_93}{on-stack replacement
...
\phantomsection\label{__index_entry_94}{range
analysis}\index{range analysis} to determine as precise a range for a
value as possible, which is useful for
\phantomsection\label{__index_entry_95}{bounds check
elimination}\index{bounds check elimination}.

\phantomsection\label{__index_entry_96}{Bounds check elimination
...
\item
  ...
  built on top of
  \href{https://v8.dev/blog/pointer-compression}{\phantomsection\label{__index_entry_97}{pointer
...
\item
  ...
  \href{https://en.wikipedia.org/wiki/W\%5EX}{\phantomsection\label{__index_entry_98}{W\^{}X}\index{W\textasciicircum{}X}}.
...
A \textbf{\phantomsection\label{__index_entry_99}{covert
channel}\index{covert channel}} is a channel where both entities intend
to communicate. A
\textbf{\phantomsection\label{__index_entry_100}{side-channel}\index{side-channel}}
...
\textbf{\phantomsection\label{__index_entry_101}{victim}\index{victim}}.
The other entity is sometimes called the
\textbf{\phantomsection\label{__index_entry_102}{spy}\index{spy}}.
...
\phantomsection\label{__index_entry_103}{micro-architectural}\index{micro-architectural}
...
\phantomsection\label{__index_entry_104}{timing
...
\href{https://en.wikipedia.org/wiki/Cache_(computing)}{\phantomsection\label{__index_entry_105}{Caches}\index{cache}}
...
\phantomsection\label{__index_entry_106}{access
...
\textbf{\phantomsection\label{__index_entry_107}{cache
hit}\index{cache!hit}}. Otherwise, it's called a
\textbf{\phantomsection\label{__index_entry_108}{cache
miss}\index{cache!miss}}.

Most systems have \phantomsection\label{__index_entry_109}{multiple
levels of cache}\index{cache!multi-level}, each with a different
trade-off between \phantomsection\label{__index_entry_110}{cache
size}\index{cache!size} and
\phantomsection\label{__index_entry_111}{access
...
\href{https://en.wikipedia.org/wiki/Locality_of_reference}{\phantomsection\label{__index_entry_112}{principle
of
locality}\index{principle of locality}}{]}\phantomsection\label{__index_entry_113}{}\index{locality of reference}.

Data is stored and transferred between cache levels in blocks of aligned
memory. Such a block is called a
\textbf{\phantomsection\label{__index_entry_114}{cache
...
\textbf{\phantomsection\label{__index_entry_116}{evicting}\index{cache!eviction}},
some other address/data from it. How that choice gets made is decided by
the
\href{https://en.wikipedia.org/wiki/Cache_replacement_policies}{\phantomsection\label{__index_entry_117}{cache
replacement policy}\index{cache!replacement policy}}{]}. Popular
replacement algorithms are
\phantomsection\label{__index_entry_118}{Least Recently Used
(LRU)}\index{cache!LRU},
\phantomsection\label{__index_entry_119}{Random}\index{cache!random replacement policy}
and
\phantomsection\label{__index_entry_120}{pseudo-LRU}\index{cache!pseudo-LRU replacement policy}.
...
the cache is
\textbf{\phantomsection\label{__index_entry_121}{fully-associative}\index{cache!fully-associative}}.
Most caches are however not fully-associative, as it's too costly to
implement. Instead, most caches are
\textbf{\phantomsection\label{__index_entry_122}{set-associative}\index{cache!set-associative}}.
...
\textbf{\phantomsection\label{__index_entry_123}{direct-mapped}\index{cache!direct-mapped}},
...
is called a \textbf{\phantomsection\label{__index_entry_124}{cache
set}\index{cache!set}}.
...
\phantomsection\label{__index_entry_125}{Cache
...
In a so-called
\textbf{\phantomsection\label{__index_entry_126}{Flush+Reload}\index{Flush+Reload}}
...
In a
\textbf{\phantomsection\label{__index_entry_127}{Prime+Probe}\index{Prime+Probe}}
...
\item
  ...
  (\textbf{\phantomsection\label{__index_entry_128}{reset
  sequence}\index{reset sequence}}).
\item
  An instruction sequence that triggers a state change
  (\textbf{\phantomsection\label{__index_entry_129}{trigger
  sequence}\index{trigger sequence}}).
\item
  An instruction sequence that leaks the inner state
  (\textbf{\phantomsection\label{__index_entry_130}{measurement
  sequence}\index{measurement sequence}}).
\end{enumerate}

Other cache-based side channel attacks following this general 3-step
approach include:
\phantomsection\label{__index_entry_131}{Flush+Flush}\index{Flush+Flush}(\citeproc{ref-Gruss2016a}{Gruss,
Maurice, Wagner, et al. 2016}),
\phantomsection\label{__index_entry_132}{Flush+Prefetch}\index{Flush+Prefetch}(\citeproc{ref-Gruss2016}{Gruss,
Maurice, Fogh, et al. 2016}),
\phantomsection\label{__index_entry_133}{Evict+Reload}\index{Evict+Reload}(\citeproc{ref-Percival2005}{Percival
2005}),
\phantomsection\label{__index_entry_134}{Evict+Time}\index{Evict+Time}(\citeproc{ref-Osvik2005}{Osvik,
Shamir, and Tromer 2005}),
\phantomsection\label{__index_entry_135}{Reload+Refresh}\index{Reload+Refresh}(\citeproc{ref-Briongos2020}{Briongos
et al. 2020}),
\phantomsection\label{__index_entry_136}{Collide+Probe}\index{Collide+Probe}(\citeproc{ref-Lipp2020}{Lipp
et al. 2020}), etc.
...
\href{https://en.wikipedia.org/wiki/Multithreading_(computer_architecture)}{\phantomsection\label{__index_entry_137}{cpu
...
\href{https://developer.chrome.com/blog/site-isolation/}{\phantomsection\label{__index_entry_138}{site
...
method}\phantomsection\label{__index_entry_139}{}\index{Spectre}.
...
\phantomsection\label{__index_entry_140}{NetSpectre}\index{NetSpectre}
...
\href{https://en.wikipedia.org/wiki/Instruction_pipelining}{\phantomsection\label{__index_entry_141}{instruction
pipelines}\index{instruction pipeline}}.
\phantomsection\label{__index_entry_142}{}\index{pipeline} In an
...
\phantomsection\label{__index_entry_143}{predict}\index{predict} which
...
\href{https://en.wikipedia.org/wiki/Branch_predictor}{\phantomsection\label{__index_entry_144}{branch
...
\item
  ...
  \phantomsection\label{__index_entry_145}{conditional
  branch}\index{conditional branch direction predictor}:
  \phantomsection\label{__index_entry_146}{taken}\index{taken branch} or
  not taken. The prediction is typically
  \phantomsection\label{__index_entry_147}{history-based}\index{history-based prediction},
  i.e.~based on the outcome of this and other branches in the recent
  past.
\item
  A predictor of the \phantomsection\label{__index_entry_148}{target of
...
\item
  ...
  \phantomsection\label{__index_entry_149}{predict the next instruction
...
\phantomsection\label{__index_entry_150}{}\index{conditional branch direction predictor}

Two examples are
\phantomsection\label{__index_entry_151}{BranchScope}\index{BranchScope}
(\citeproc{ref-Evtyushkin2018}{Evtyushkin et al. 2018}) and
\phantomsection\label{__index_entry_152}{BlueThunder}\index{BlueThunder}
...
\hyperref[aslr]{\phantomsection\label{__index_entry_153}{ASLR}\index{ASLR}}.

\subsubsection{Branch target predictor side-channel
attacks}\label{branch-target-predictor-side-channel-attacks}

\phantomsection\label{__index_entry_154}{}\index{Branch target predictor}

Two examples are
\phantomsection\label{__index_entry_155}{SBPA}\index{SBPA}
(\citeproc{ref-Aciicmez2007}{Aciiçmez, Kaya Koç, and Seifert 2007}) and
\phantomsection\label{__index_entry_156}{BranchShadow}\index{BranchShadow}
(\citeproc{ref-Lee2017}{Lee et al. 2017}). These earlier attacks are
based on making a branch in the spy process alias in the
\phantomsection\label{__index_entry_157}{Branch Target Buffer
...
\phantomsection\label{__index_entry_158}{last branch
records}\index{last branch record},
\phantomsection\label{__index_entry_159}{instruction
traces}\index{instruction trace} or
\phantomsection\label{__index_entry_160}{performance
...
\phantomsection\label{__index_entry_161}{}\index{return address predictor}

One example is
\phantomsection\label{__index_entry_162}{Hyper-Channel}\index{Hyper-Channel}
...
\item
  ...
  (\emph{\phantomsection\label{__index_entry_163}{reset
...
\textbf{\phantomsection\label{__index_entry_166}{control
...
\textbf{\phantomsection\label{__index_entry_167}{true data
dependencies}\index{true data dependency}},
\textbf{\phantomsection\label{__index_entry_168}{anti-dependencies}\index{data dependency}}
and \textbf{\phantomsection\label{__index_entry_169}{output
...
\textbf{\phantomsection\label{__index_entry_170}{predictions}\index{prediction}}.
...
\textbf{\phantomsection\label{__index_entry_171}{speculation}\index{speculation}}.
...
\textbf{\phantomsection\label{__index_entry_172}{mis-speculation}\index{mis-speculation}},
are called \textbf{\phantomsection\label{__index_entry_173}{transient
instructions}\index{transient instructions}}.\footnote{Transient
  ...
  been called
  \textbf{\phantomsection\label{__index_entry_174}{wrong-path
...
\textbf{\phantomsection\label{__index_entry_175}{architectural
effects}\index{architectural effects}} of transient instructions need to
be undone, but the
\textbf{\phantomsection\label{__index_entry_176}{micro-architectural
...
\textbf{\phantomsection\label{__index_entry_177}{Faulting
...
\textbf{\phantomsection\label{__index_entry_178}{transient
...
\textbf{\phantomsection\label{__index_entry_179}{Transient execution
...
\phantomsection\label{__index_entry_180}{Spectre}\index{Spectre}
(\citeproc{ref-Kocher2019}{Kocher et al. 2019}) and
\phantomsection\label{__index_entry_181}{Meltdown}\index{Meltdown}
...
\phantomsection\label{__index_entry_182}{dead store optimization
...
It still uses
\phantomsection\label{__index_entry_183}{\texttt{memset}}\index{memset}
