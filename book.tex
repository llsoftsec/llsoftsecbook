...
book and refer to that section here}}. We then continue with a more
detailed discussion of the various types of vulnerabilities, along with
their mitigations, presented in a rough chronological order of their
...
\tododiv{Consider adding a whole section on MTE and its applications}
...
\tododiv{Write section on transient execution attacks}
...
\tododiv{Write chapter on physical access side-channel attacks.}
